...
export default class RiderScreen extends React.Component {
  ...
  async retrieveItem(key) {
    try {
      ...
      this.setState({phone_number: item.phoneNumber});
      return item;
    } catch (error) {
      console.log(error.message);
    }
    ...
    return (
      ...
      <KeyboardAvoidingView style={styles.container} behavior="padding">
        ...
        <MenuProvider
          ...
          <Menu>
            <MenuTrigger style={{fontSize: 26, color: 'orange', alignItems: 'center'}} text="Manage Settings" />
            <MenuOptions>
            <ScrollView style={{ maxHeight: 250 }}>
              <MenuOption>
                ...
                <TextInput
                  ...
                  onChangeText={(text) => this.storeItem(this.key: phoneNumber, this.value: text)}/>
              </MenuOption>
              <MenuOption>
                <TextInput
                  style={{
                  ...
                  onChangeText={(text) => this.storeItem(this.key: notes, this.value: text)}/>
              </MenuOption>
              <MenuOption>
                <Button
                  onPress={() =>
